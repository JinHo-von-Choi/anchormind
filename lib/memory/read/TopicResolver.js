...
import { keyScopeClause, exactScopeClause } from "../keyScope.js";
...
async function aggregateTopics(pool, scope, wrongTopic) {
  ...
  const keyClause = scope.strictScope === true
    ? exactScopeClause(params, "f", scope)
    : keyScopeClause(params, "key_id", {
 ...
 * @param {Object}   scopeOptions   - { keyId, groupKeyIds, workspace, strictScope }
