...
export class CaseEventStore {
  ...
  async getByCase(caseId, opts = {}) {
    ...
    const scopeClause = exactScopeClause(params, "ce", { keyId, workspace });
  ...
  async getEdgesByEvents(eventIds, keyId = null) {
    ...
    if (scope.keyId != null || scope.workspace != null) {
      ...
      const fromScope = exactScopeClause(params, "ce_from", scope);
      const toScope = exactScopeClause(params, "ce_to", scope);
