...
export class FragmentStore {
  ...
  searchBySemantic(queryEmbedding, limit, minSimilarity, agentId, keyId, includeSuperseded, timeRange, workspace, affect, morphemeOnly = false, searchOptions = {}) {
    return this.reader.searchBySemantic(queryEmbedding, limit, minSimilarity, agentId, keyId, includeSuperseded, timeRange, workspace, affect, morphemeOnly, searchOptions);
  }
