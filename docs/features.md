...
|`ReconsolidationEngine` (`lib/memory/link/ReconsolidationEngine.js`)|tool_feedback 누적|link weight 갱신|fragment_links 부재, search_event_id 무효|`ENABLE_RECONSOLIDATION`|`memento_link_weight_*`|migration-027|
